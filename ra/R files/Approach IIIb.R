...
prediction_SCQM_internal_25 <- findPrediction(SCQM, result_SCQM)
prediction_BSRBR_internal_25 <- findPrediction(BSRBR, result_BSRBR)
...
prediction_SCQM_internal_50 <- findPrediction(SCQM, result_SCQM)
prediction_BSRBR_internal_50 <- findPrediction(BSRBR, result_BSRBR)
...
prediction_SCQM_external_25 <- findPrediction(SCQM, result_BSRBR)
...
prediction_SCQM_external_50 <- findPrediction(SCQM, result_BSRBR)
...
prediction_BSRBR_external_25 <- findPrediction(BSRBR, result_SCQM)
...
prediction_BSRBR_external_50 <- findPrediction(BSRBR, result_SCQM)
