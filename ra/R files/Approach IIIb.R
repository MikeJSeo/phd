...
result <- secondStage(samples1 = samples_BSRBR, samples2 = samples_SCQM, samples3 = samples_REFLEX, samples4 = samples_TOWARD, 
                      y5 = y_TOWARD2, Omega5 = Omega_TOWARD2, jags_file = "second stage-ApproachIII-0.txt", w = 0, niter = 200000)
...
result <- secondStage(samples1 = samples_BSRBR, samples2 = samples_SCQM, samples3 = samples_REFLEX, samples4 = samples_TOWARD, 
                      y5 = y_TOWARD2, Omega5 = Omega_TOWARD2, jags_file = "second stage-ApproachIII.txt", w = 0.25, niter = 200000)
...
result <- secondStage(samples1 = samples_BSRBR, samples2 = samples_SCQM, samples3 = samples_REFLEX, samples4 = samples_TOWARD, 
                      y5 = y_TOWARD2, Omega5 = Omega_TOWARD2, jags_file = "second stage-ApproachIII.txt", w = 0.5, niter =200000)
...
result <- secondStage2(samples1 = samples_BSRBR, samples2 = samples_REFLEX, samples3 = samples_TOWARD, 
                       y4 = y_TOWARD2, Omega4 = Omega_TOWARD2, jags_file = "second stage-ApproachIII-external-0.txt", w = 0, niter = 200000)
...
result <- secondStage2(samples1 = samples_BSRBR, samples2 = samples_REFLEX, samples3 = samples_TOWARD, 
                       y4 = y_TOWARD2, Omega4 = Omega_TOWARD2, jags_file = "second stage-ApproachIII-external.txt", w = 0.25, niter = 200000)
result_SCQM <- result
for(i in 1:10){
  result_SCQM[[1]][,i] <- samples_BSRBR[[1]][,i]
  result_SCQM[[2]][,i] <- samples_BSRBR[[2]][,i]
...
result <- secondStage2(samples1 = samples_BSRBR, samples2 = samples_REFLEX, samples3 = samples_TOWARD, 
                       y4 = y_TOWARD2, Omega4 = Omega_TOWARD2, jags_file = "second stage-ApproachIII-external.txt", w = 0.5, niter = 200000)
result_SCQM <- result
for(i in 1:10){
  result_SCQM[[1]][,i] <- samples_BSRBR[[1]][,i]
  result_SCQM[[2]][,i] <- samples_BSRBR[[2]][,i]
