...
col_labels <- c("age:treat", "gender:treat", "diabetes:treat", "stable_cad:trea", "multivessel:treat", "ladtreated:treat", "overlap:treat", "m_dia_above_3:treat", "num_stent:treat", "treat")
