...
```{r glmm_full}
m2 <- lmer(y ~ studyid + (baseseverity.hamd_total_start. + age + sex_m1_f2 + onset + episode_frequency_1_2_3over + episode_duration_wk + gilty_agitationHAM10_11_12_15_17 + body_symptoms_HAM9_13_14 + sleep_problems + anhedonia_redardationHAM1_2_3_16)*treat + (-1 + treat|studyid), data = mydata)
summary(m2)
```

```{r}
# first group
group1 <- c(15, 25, 1, 20, 1, 42.0356886, 5.4821570, 5, 5, 7.4845361)
...
#second group
group2 <- c(25, 45, 0, 45, 0, 42.0356886, 5.4821570, 2, 1.5, 7.4845361)
...
m3 <- lm(y ~ studyid + (baseseverity.hamd_total_start. + age + sex_m1_f2 + onset + episode_frequency_1_2_3over + episode_duration_wk + gilty_agitationHAM10_11_12_15_17 + body_symptoms_HAM9_13_14 + sleep_problems + anhedonia_redardationHAM1_2_3_16)*treat, data = mydata)
s3 <- step(m3, scope = list(lower = ~ baseseverity.hamd_total_start. + age + sex_m1_f2 + onset + episode_frequency_1_2_3over + episode_duration_wk + gilty_agitationHAM10_11_12_15_17 + body_symptoms_HAM9_13_14 + sleep_problems + anhedonia_redardationHAM1_2_3_16 + treat), direction = "both")
```
...
```{r glmnet}
set.seed(1)
data_glmnet <- model.matrix(y~ -1 + (baseseverity.hamd_total_start. + age + sex_m1_f2 + onset + episode_frequency_1_2_3over + episode_duration_wk + gilty_agitationHAM10_11_12_15_17 + body_symptoms_HAM9_13_14 + sleep_problems + anhedonia_redardationHAM1_2_3_16) * treat, data = mydata)
data_glmnet <- cbind(y = mydata$y, data_glmnet = data_glmnet)

p.fac.depression = c(rep(0, 10), 0, rep(1, 10)) #No shrinkage for treatment effect and prognostic effect
...
```{r lasso_se, cache = TRUE, eval = FALSE}
...
```{r ridge_sd, cache = TRUE, eval = FALSE}
