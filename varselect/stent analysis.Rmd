...
# gender: 
contr <- c(rep(0, 8), rep(0, 9), 1, rep(0, 5), 1.0691515, 0, 0, 3.1705418)
v1 <- vcov(m2)
...
contr <- c(rep(0, 8), rep(0, 9), 1, rep(0, 5), -0.9352369, 0, 0, -0.6300019)
v2 <- vcov(m2)
...
```{r}
# ladtreated = 1 (1.0691515), num_stents = 5 (3.1705418)
mat1 <- do.call(rbind, model_SSVS[,c("d[2]", "g[6]", "g[9]")])
sum1 <- mat1 %*% c(1, 1.0691515, 3.1705418)
...
# # ladtreated = 0 (-0.9352369), num_stents = 1 (-0.6300019)
sum2 <- mat1 %*% c(1, -0.9352369, -0.6300019)
