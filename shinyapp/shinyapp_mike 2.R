...
server <- shinyServer(function(input, output) {
  ...
  output$w1_fibser_q2 <- renderUI({
    ...
    sliderInput("w1_fibser_q2", "FIBSER item 1 at week 1", min = 0, max = 7, value = value, step = 0.1)
  })
  ...
  output$w1_fibser_q3 <- renderUI({
    ...
    sliderInput("w1_fibser_q3", "FIBSER item 2 at week 1", min = 0, max = 7, value = value, step = 0.1)
  })
  ...
  output$w1_fibser_q4 <- renderUI({
    ...
    sliderInput("w1_fibser_q4", "FIBSER item 3 at week 1", min = 0, max = 7, value = value, step = 0.1)
  })
  ...
  output$phq9_q1_3 <- renderUI({
    ...
    sliderInput("phq9_q1_3", "PHQ-9 item 1 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$phq9_q2_3 <- renderUI({
    ...
    sliderInput("phq9_q2_3", "PHQ-9 item 2 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$phq9_q3_3 <- renderUI({
    ...
    sliderInput("phq9_q3_3", "PHQ-9 item 3 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$phq9_q4_3 <- renderUI({
    ...
    sliderInput("phq9_q4_3", "PHQ-9 item 4 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$phq9_q5_3 <- renderUI({
    ...
    sliderInput("phq9_q5_3", "PHQ-9 item 5 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$phq9_q6_3 <- renderUI({
    ...
    sliderInput("phq9_q6_3", "PHQ-9 item 6 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$phq9_q7_3 <- renderUI({
    ...
    sliderInput("phq9_q7_3", "PHQ-9 item 7 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$phq9_q8_3 <- renderUI({
    ...
    sliderInput("phq9_q8_3", "PHQ-9 item 8 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$phq9_q9_3 <- renderUI({
    ...
    sliderInput("phq9_q9_3", "PHQ-9 item 9 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$w3_fibser_q2 <- renderUI({
    ...
    sliderInput("w3_fibser_q2", "FIBSER item 1 at week 3", min = 0, max = 7, value = value, step = 0.1)
  })
  ...
  output$w3_fibser_q3 <- renderUI({
    ...
    sliderInput("w3_fibser_q3", "FIBSER item 2 at week 3", min = 0, max = 7, value = value, step = 0.1)
  })
  ...
  output$w3_fibser_q4 <- renderUI({
    ...
    sliderInput("w3_fibser_q4", "FIBSER item 3 at week 3", min = 0, max = 7, value = value, step = 0.1)
  })
  ...
  output$bdi_q1_1 <- renderUI({
    ...
    sliderInput("bdi_q1_1", "BDI-II item 1 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q2_1 <- renderUI({
    ...
    sliderInput("bdi_q2_1", "BDI-II item 2 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q3_1 <- renderUI({
    ...
    sliderInput("bdi_q3_1", "BDI-II item 3 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q4_1 <- renderUI({
    ...
    sliderInput("bdi_q4_1", "BDI-II item 4 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q5_1 <- renderUI({
    ...
    sliderInput("bdi_q5_1", "BDI-II item 5 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q6_1 <- renderUI({
    ...
    sliderInput("bdi_q6_1", "BDI-II item 6 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q7_1 <- renderUI({
    ...
    sliderInput("bdi_q7_1", "BDI-II item 7 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q8_1 <- renderUI({
   if(input$examples == "average"){
    ...
    sliderInput("bdi_q8_1", "BDI-II item 8 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q9_1 <- renderUI({
    ...
    sliderInput("bdi_q9_1", "BDI-II item 9 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q10_1 <- renderUI({
    ...
    sliderInput("bdi_q10_1", "BDI-II item 10 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q11_1 <- renderUI({
    ...
    sliderInput("bdi_q11_1", "BDI-II item 11 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q12_1 <- renderUI({
    ...
    sliderInput("bdi_q12_1", "BDI-II item 12 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q13_1 <- renderUI({
    ...
    sliderInput("bdi_q13_1", "BDI-II item 13 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q14_1 <- renderUI({
    ...
    sliderInput("bdi_q14_1", "BDI-II item 14 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q15_1 <- renderUI({
    ...
    sliderInput("bdi_q15_1", "BDI-II item 15 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q16_1longer <- renderUI({
    ...
    sliderInput("bdi_q16_1longer", "Hypersomnia at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q16_1shorter <- renderUI({
    ...
    sliderInput("bdi_q16_1shorter", "Insomnia at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q17_1 <- renderUI({
    ...
    sliderInput("bdi_q17_1", "BDI-II item 17 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q18_1longer <- renderUI({
    ...
    sliderInput("bdi_q18_1longer", "Decreased appetite at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q18_1shorter <- renderUI({
    ...
    sliderInput("bdi_q18_1shorter", "Increased appetite at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q19_1 <- renderUI({
    ...
    sliderInput("bdi_q19_1", "BDI-II item 19 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q20_1 <- renderUI({
    ...
    sliderInput("bdi_q20_1", "BDI-II item 20 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q21_1 <- renderUI({
    ...
    sliderInput("bdi_q21_1", "BDI-II item 21 at week 1", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q1_3 <- renderUI({
    ...
    sliderInput("bdi_q1_3", "BDI-II item 1 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q2_3 <- renderUI({
    ...
    sliderInput("bdi_q2_3", "BDI-II item 2 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q3_3 <- renderUI({
    ...
    sliderInput("bdi_q3_3", "BDI-II item 3 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q4_3 <- renderUI({
    ...
    sliderInput("bdi_q4_3", "BDI-II item 4 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q5_3 <- renderUI({
    ...
    sliderInput("bdi_q5_3", "BDI-II item 5 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q6_3 <- renderUI({
    ...
    sliderInput("bdi_q6_3", "BDI-II item 6 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q7_3 <- renderUI({
    ...
    sliderInput("bdi_q7_3", "BDI-II item 7 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q8_3 <- renderUI({
    ...
    sliderInput("bdi_q8_3", "BDI-II item 8 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q9_3 <- renderUI({
    ...
    sliderInput("bdi_q9_3", "BDI-II item 9 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q10_3 <- renderUI({
    ...
    sliderInput("bdi_q10_3", "BDI-II item 10 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q11_3 <- renderUI({
    ...
    sliderInput("bdi_q11_3", "BDI-II item 11 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q12_3 <- renderUI({
    ...
    sliderInput("bdi_q12_3", "BDI-II item 12 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q13_3 <- renderUI({
    ...
    sliderInput("bdi_q13_3", "BDI-II item 13 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q14_3 <- renderUI({
    ...
    sliderInput("bdi_q14_3", "BDI-II item 14 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q15_3 <- renderUI({
    ...
    sliderInput("bdi_q15_3", "BDI-II item 15 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q16_3longer <- renderUI({
    ...
    sliderInput("bdi_q16_3longer", "Hypersomnia at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q16_3shorter <- renderUI({
    ...
    sliderInput("bdi_q16_3shorter", "Insomnia at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q17_3 <- renderUI({
    ...
    sliderInput("bdi_q17_3", "BDI-II item 17 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q18_3longer <- renderUI({
    ...
    sliderInput("bdi_q18_3longer", "Decreased appetite at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q18_3shorter <- renderUI({
    ...
    sliderInput("bdi_q18_3shorter", "Increased appetite at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q19_3 <- renderUI({
    ...
    sliderInput("bdi_q19_3", "BDI-II item 19 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q20_3 <- renderUI({
    ...
    sliderInput("bdi_q20_3", "BDI-II item 20 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
  ...
  output$bdi_q21_3 <- renderUI({
    ...
    sliderInput("bdi_q21_3", "BDI-II item 21 at week 3", min = 0, max = 3, value = value, step = 0.1)
  })
